...
Current manifests record Python `0.3.22` and TypeScript `0.2.27`, which do not satisfy the documented MAJOR.MINOR alignment. This factual skew does not change the release requirement above.
