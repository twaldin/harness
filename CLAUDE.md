...
`aider`, `amp`, `swe-agent`, `qwen`, `continue-cli`, `pi`, `omp`, `factory-droid`, `kilo`, `crush`, `hermes`, `goose`, `cline`, `copilot`, `cursor` —
...
- Adapters: twenty registered names, exact strings — `aider`, `amp`, `claude-code`,
