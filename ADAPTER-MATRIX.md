...
shared fixture files: `aider`, `claude-code`, `codex`, `continue-cli`, `copilot`,
`crush`, `factory-droid`, `gemini`, `hermes`, `kilo`, `omp`, `openclaude`, `opencode`, `pi`,
...
Codex, `HERMES_HOME` for Hermes, `COPILOT_HOME` for Copilot, and
