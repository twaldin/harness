...
A failed interrupt request keeps an already-latched native result and closes
the local handle instead of allowing follow-up; a pending interrupt mutation
is not reported as a settled turn.
