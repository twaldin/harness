...
interface RunSpec {
  harness: string                  // "claude-code" | "cline" | "openclaude" | "factory-droid" | "codex" | "gemini" | "opencode" | "aider" | "swe-agent" | "qwen" | "continue-cli" | "pi" | "omp" | "crush" | "kilo" | "hermes" | "copilot" | "goose" | "mistral-vibe"
...
| `defaultModel` | used when RunSpec.model is unset; `hermes`, `goose`, `copilot` and `mistral-vibe` have none (empty sentinel), so upstream selection applies and the reported model is null |
...
```
["aider", "claude-code", "cline", "codex", "continue-cli", "copilot", "crush", "factory-droid", "gemini", "goose", "hermes", "kilo", "mistral-vibe", "omp", "openclaude", "opencode", "pi", "qwen", "swe-agent"]
```
